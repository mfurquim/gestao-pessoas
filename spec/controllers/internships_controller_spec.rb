...
RSpec.describe InternshipsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested internship as @internship" do
      internship = Internship.create! valid_attributes
      get :show, params: {id: internship.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested internship as @internship" do
      internship = Internship.create! valid_attributes
      get :edit, params: {id: internship.to_param}, session: valid_session
      expect(assigns(:internship)).to eq(internship)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Internship" do
        expect {
          post :create, params: {internship: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved internship as @internship" do
        post :create, params: {internship: invalid_attributes}, session: valid_session
        expect(assigns(:internship)).to be_a_new(Internship)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested internship" do
        internship = Internship.create! valid_attributes
        put :update, params: {id: internship.to_param, internship: new_attributes}, session: valid_session
        internship.reload
      ...
      it "assigns the requested internship as @internship" do
        internship = Internship.create! valid_attributes
        put :update, params: {id: internship.to_param, internship: valid_attributes}, session: valid_session
        expect(assigns(:internship)).to eq(internship)
      end
    ...
    context "with invalid params" do
      it "assigns the internship as @internship" do
        internship = Internship.create! valid_attributes
        put :update, params: {id: internship.to_param, internship: invalid_attributes}, session: valid_session
        expect(assigns(:internship)).to eq(internship)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested internship" do
      internship = Internship.create! valid_attributes
      expect {
        delete :destroy, params: {id: internship.to_param}, session: valid_session
      }.to change(Internship, :count).by(-1)
    end
